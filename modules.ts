...
//There are three main things to consider when writing modulebased code in TypeScript:
...
//TypeScript 4.5 also allows for individual imports to be prefixed with type to indicate that the
//imported reference is a type:
...
//Together these allow a non-TypeScript transpiler like Babel, swc or esbuild to know what imports
...
//Then thee files can be imported via a require statement:
...
//There is a mis-match in features between CommonJS and ES Modules regarding the distinction
//between a default import and a module namespace object import. TypeScript has a compiler flag to
//reduce the friction between the two different sets of constraints with esModuleInterop.
...
//compiler option module is not commonjs , is included for backwards compatibility. The Node
...
const constans_js_1 = require("./constants.js");
exports.twoPi = constans_js_1.valueOfPi * 2;
